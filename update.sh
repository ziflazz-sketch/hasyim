...
wget -q https://raw.githubusercontent.com/ziflazz-sketch/hasyim/main/install.sh \
-O /usr/local/bin/install.sh
chmod +x /usr/local/bin/install.sh
wget -q https://raw.githubusercontent.com/ziflazz-sketch/hasyim/main/zivpn-manager \
-O /usr/local/bin/zivpn-manager
chmod +x /usr/local/bin/zivpn-manager
wget -q https://raw.githubusercontent.com/ziflazz-sketch/hasyim/main/zivpn_helper.sh \
-O /usr/local/bin/zivpn_helper.sh
chmod +x /usr/local/bin/zivpn_helper.sh
wget -q https://raw.githubusercontent.com/ziflazz-sketch/hasyim/main/update.sh \
